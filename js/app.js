...
// ==================== AI 潤稿功能 ====================
  const POLISH_PROMPTS = {
    fluency: '請潤飾以下中文作文，使文章更加通順、生動且自然。\n\n請遵守以下規則：\n1. 忠於原文，不改變原意。\n2. 不得新增原文未提及的重要人物、事件、地點、時間、食物、物品或其他事實。\n3. 保留原有事件順序與段落結構。\n4. 優先修正文法、標點、用詞及語句流暢度。\n5. 可適度補充符合情境的景物、感官或心理描寫，但不得編造情節。\n6. 修辭自然即可，不要過度堆砌華麗詞藻。\n7. 保持學生作文風格，讓文章真實、自然且易讀。\n\n直接回傳潤飾後的全文，不要加入任何說明：',
    expand: '請在不改變原意的情況下，為以下中文文章補充更多細節與描寫，使內容更豐富。直接回傳擴寫後的全文，不要加入任何說明：',
    formal: '請將以下中文文章轉換為較正式的書面語氣，適合投稿或學術用途。直接回傳轉換後的全文，不要加入任何說明：',
    essay: '請潤飾以下中文作文，使文章更加通順、生動且自然。\n\n請遵守以下規則：\n1. 忠於原文，不改變原意。\n2. 不得新增原文未提及的重要人物、事件、地點、時間、食物、物品或其他事實。\n3. 保留原有事件順序與段落結構。\n4. 優先修正文法、標點、用詞及語句流暢度。\n5. 可適度補充符合情境的景物、感官或心理描寫，但不得編造情節。\n6. 修辭自然即可，不要過度堆砌華麗詞藻。\n7. 保持學生作文風格，讓文章真實、自然且易讀。\n\n直接回傳潤飾後的全文，不要加入任何說明：',
    complete: '請將以下中文作文整理並補充成一篇完整的文章。\n\n請遵守以下規則：\n1. 忠於原文，不改變主要事件、人物及故事走向。\n2. 若文章內容未完成，可依照前文內容合理補足後續情節，使故事自然結束。\n3. 補充內容應以最小幅度推論為原則，不得新增與原文無關的重要人物、重大事件或不合理情節。\n4. 保留原有事件順序，並整理成具有「開頭、經過、轉折、結尾」的完整作文。\n5. 可適度補充人物感受、景物描寫及心得，讓文章更完整，但避免過度華麗或不自然的修辭。\n6. 若原文缺少結語，請補上一段自然的心得或感想，作為全文結尾。\n7. 保持學生作文風格，內容真實自然。\n\n直接回傳完整作文，不要加入任何說明：'
  };
